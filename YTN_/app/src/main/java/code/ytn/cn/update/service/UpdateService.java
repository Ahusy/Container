package code.ytn.cn.update.service;
...
public class UpdateService extends Service{
    public static final String DOWNLOAD_FOLDER_NAME = "ytnmall";
    public static final String DOWNLOAD_FILE_NAME = "ytnmall_client_new.apk";
    ...
    public static boolean install(Context context, String filePath) {
        ...
        if (file.length() > 0 && file.exists() && file.isFile()) {
            if(Build.VERSION.SDK_INT>=24) {//判读版本是否在7.0以上
                Uri apkUri = FileProvider.getUriForFile(context, "code.ytn.cn.fileprovider",file);//在AndroidManifest中的android:authorities值
