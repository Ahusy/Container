...
import code.ytn.cn.shop.adapter.AddGoodsAdapter;
 ...
 * 代客下单（添加商品）
 */
public class AddGoodsActivity extends ToolBarActivity implements View.OnClickListener {

    @ViewInject(R.id.add_goods_recy)
    private RecyclerView recy;
    @ViewInject(R.id.add_goods_cancel)
    private TextView cancel;
    @ViewInject(R.id.add_goods_comit)
        ...
        switch (requestCode) {
            case REQUEST_NET_ONE:
                if (entity != null) {
                    ...
                    AddGoodsAdapter adapter = new AddGoodsAdapter(this, entities);
