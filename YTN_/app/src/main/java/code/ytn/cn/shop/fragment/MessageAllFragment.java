...
public class MessageAllFragment extends BaseFragment {
            ...
            case REQUEST_NET_ONE:
                if (messageEntity != null) {
                    ...
                    if (listEntities != null && listEntities.size() > 0) {
                        lv.setAdapter(new CommonAdapter<MessageEntity.MessageListEntity>(getActivity(), listEntities, R.layout.item_frag_message) {
                            @Override
                            public void convert(CommonViewHolder holder, MessageEntity.MessageListEntity messageListEntity, int position, View convertView) {
                                ...
                                holder.setOnClickListener(R.id.btn_zd, v -> {
                                    ...
                                    intent.putExtra("change", "msg_all");
    ...
    private BroadcastReceiver mAdDownLoadReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if ("msg_read".equals(change) || "msg_uRead".equals(change)) {
