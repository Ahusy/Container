...
public class HttpUtil {
	...
	private static final String USER_AGENT = "YTN Android Client v1.0";
...
//		params.put("appVersion", VersionInfoUtils.getVersion(context));
		...
		if(!params.containsKey(Config.INTERFACE_NAME)){
	...
	private static String getSidParam(IdentityHashMap<String, String> params) {
		...
		if (params != null) {
			...
			result = EnCryptionUtils.MD5(str.toString().replace(",",""));
...
//                                    + " : " + session.getValueNames()[0]
	...
	public static class Config {
		...
		//接口签名key
		public static final String INTERFACE_SIGN_KEY = "kX@y8qBLcms@$ViM7CZH5OQcUm&jJlnh";
		//接口参数名称
